    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                new Customer { Id = 3, FullName = "Admin One", Email = "admin_one@promelec.com", Phone = "5550001111", Address = "Admin Address 1", Password = BCrypt.Net.BCrypt.HashPassword("SuperP@$$w0rd1.10"), Role = "Admin" },
